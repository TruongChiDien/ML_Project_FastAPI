...
async def create_upload_files(files: List[UploadFile] = File(...)):
    ...
    images_resized = [img for img in images]
...
async def main():
    ...
    <marquee width="525" behavior="alternate">
        <h1 style="color:red;font-family:Arial">Please Upload Your Scenes!</h1>
    </marquee>
    <h3 style="font-family:Arial">We'll Try to Predict Which of These Categories They Are:</h3>
    <br>
    """
